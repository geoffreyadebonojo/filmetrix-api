...
RSpec.describe Assembler::Matcher, type: :model do
  ...
  describe "in person-to-person matches" do
    it "doesn't find false positives" do
      credit_list = eval(File.read("spec/fixtures/matcher/tom-cruise-kevin-hart-list.json").gsub("null", "nil"))
    ...
    it "finds overlapping entries between two people" do
      credit_list = eval(File.read("spec/fixtures/matcher/tom-cruise-brad-pitt-list.json").gsub("null", "nil"))
      matcher = Assembler::Matcher.new(credit_list)
    ...
    it "finds overlapping entries between multiple people" do
      credit_list = eval(File.read("spec/fixtures/matcher/tom-brad-morgan.json").gsub("null", "nil"))
      matcher = Assembler::Matcher.new(credit_list)
  ...
  describe "in movie-to-movie matches" do
    it "doesn't find false positives" do
      credit_list = eval(File.read("spec/fixtures/matcher/busan-mission-impossible-list.json").gsub("null", "nil"))
      matcher = Assembler::Matcher.new(credit_list)
    ...
    it "finds overlapping entries between two credit lists" do
      credit_list = eval(File.read("spec/fixtures/matcher/vampire-mission-impossible-list.json").gsub("null", "nil"))
      matcher = Assembler::Matcher.new(credit_list)
    ...
    it "finds overlapping entries between multiple credit lists" do
      credit_list = eval(File.read("spec/fixtures/matcher/se7en-vampire-oblivion-list.json").gsub("null", "nil"))
      matcher = Assembler::Matcher.new(credit_list)
